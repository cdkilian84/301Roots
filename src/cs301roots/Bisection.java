...
//Class that implements the bisection method function
public class Bisection {
    
    //Method to calculate the bisectional root of a provided function. Inputs include the function being tested,
    ...
    public void runAlg(Function func, double a, double b, int nMax, double epsilon){
        ...
        if(((fOfA > 0) && (fOfB > 0)) || ((fOfA < 0) && (fOfB < 0))){
            ...
            outputResults(plot.toString(), "Bisection Results.csv");
        }
    }
